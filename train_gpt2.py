...
# generat! right now x is (B, T) where B = 5, T = 8
# set the seed to 42
...
while x.size(1) < max_length:
    ...
    # Take the logits a the last position
    ...
    # select a token from top-k probabilites
    # note: multinomial does not deman the input to sum to 1
